...
export const surfPoints: SurfPoint[] = [
  ...
  },
  {
    ...
    bestSwell: 'S, SSW, SSE, SW',
    note: '黒潮町。双海の南側に位置する砂浜。太平洋に南向きに開けたオープンビーチ。南うねりに素直に反応。',
    beachFacing: 'S',
    tideStation: 'muroto',
    bayGeometry: {
      type: 'open',
  ...
  },
  {
    ...
    bestSwell: 'S, SSW, SSE, SW',
    note: '黒潮町大方。浮鞭海岸。太平洋に南向きに開けたオープンビーチ。南うねりに素直に反応。入野海岸と連続する砂浜で、コンスタントにサーフできる高知西部の人気ポイント。',
    beachFacing: 'S',
    tideStation: 'muroto',
    bayGeometry: {
      type: 'open',
  ...
  },
  {
    ...
    bestSwell: 'S, SSW, SSE, SW',
    note: '黒潮町入野。入野松原に面した砂浜。太平洋に南向きに開けたオープンビーチ。大方浮鞭と連続する長大な砂浜の中央エリア。',
    beachFacing: 'S',
    tideStation: 'muroto',
    bayGeometry: {
      type: 'open',
