...
export const surfPoints: SurfPoint[] = [
  ...
  },
  {
    ...
    bestSwell: 'SSE, SE, S, ESE',
    note: '黒潮町大方。浮鞭海岸。海岸線は北西〜南東に走り、太平洋に南〜南東向きに開けたオープンビーチ。南〜南東うねりに素直に反応。入野海岸と連続する砂浜で、コンスタントにサーフできる高知西部の人気ポイント。',
    beachFacing: 'SSE',
    tideStation: 'muroto',
    bayGeometry: {
      type: 'open',
  ...
  },
  {
    ...
    bestSwell: 'SSE, SE, S, ESE',
    note: '黒潮町入野。入野松原に面した砂浜。海岸線は北西〜南東に走り、太平洋に南〜南東向きに開けたオープンビーチ。大方浮鞭と連続する長大な砂浜の中央エリア。',
    beachFacing: 'SSE',
    tideStation: 'muroto',
    bayGeometry: {
      type: 'open',
